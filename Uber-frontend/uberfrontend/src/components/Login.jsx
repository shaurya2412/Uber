...
<div className="min-h-screen w-screen flex">
  ...
  <h2 className="text-2xl text-center font-bold text-centern text-gray-500 items-center  mb-8">What's your phone number or email?</h2>
  ...
  <form className="space-y-4">
    ...
    <input type="email" placeholder="Enter phone number or email" className="border border-gray-300 px-3 py-2 rounded-xl bg-gray-200 text-black w-full" />
    <input type="password" placeholder="Password" className="border border-gray-300 px-3 py-2 rounded-xl bg-gray-200 rounded text-black w-full" />
...
Login          </button>
          ...
          <p className="text-center text-xs text-gray-400 mt-2">
            ...
            By proceeding, you consent to receiving calls, WhatsApp or SMS/RCS messages, including by automated means, from Uber and its affiliates to the number provided.<span className="underline cursor-pointer">Terms of Service</span> and <span className="underline cursor-pointer">Privacy Policy</span>.
          </p>
